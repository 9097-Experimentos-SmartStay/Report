...
- [Capítulo VII: DevOps Practices](#capítulo-vii-devops-practices)
  - [7.1. ContinuousIntegration](#71-continuousintegration)
...
| 1.1 | 07/09/2026 | Samuel Jesus Bonifacio Jaramillo | Reestructuración del informe según el enunciado del Final Project Statement: alineación de la estructura de capítulos al esquema máster (Cap I–VIII), corrección de la tabla de integrantes, correcciones de redacción y actualización de la sección Student Outcome según el Anexo A |
| 1.2 | 07/09/2026 | Samuel Jesus Bonifacio Jaramillo | Ajuste del Capítulo V a la numeración del alcance del Avance 1 (5.2.1–5.2.7 sin "Acuerdo de Servicio – SaaS") e incorporación de la sección de avance "Avance de Conclusiones, Bibliografía y Anexos" (docs/anexes.md) |
| 1.3 | 07/09/2026 | Samuel Jesus Bonifacio Jaramillo | Redacción del avance de conclusiones, bibliografía preliminar y anexos en docs/anexes.md según el formato del equipo (Conclusiones · videos de validación/producto/equipo · Bibliografía · Anexos) |
...
<table border>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <b>AV1</b><br>
        Bonifacio Jaramillo, Samuel Jesus — <em>pendiente de redacción</em><br>
...
> **Nota:** según el Anexo A del enunciado, esta sección requiere además una subsección por alumno que describa la relación entre el outcome, sus dimensiones y el trabajo realizado (se complementa con los testimonios del video About-the-Team). Pendiente de redacción por el equipo.
